...
void wk_usart1_init(void)
{
  ...
  usart_rs485_delay_time_config(USART1, 0, 0);
...
void wk_usart3_init(void)
{
  ...
  /* configure the TX pin */
  gpio_pin_mux_config(UDBTX_GPIO_PORT, GPIO_PINS_SOURCE10, GPIO_MUX_7);
  gpio_init_struct.gpio_drive_strength = GPIO_DRIVE_STRENGTH_MODERATE;
  gpio_init_struct.gpio_out_type = GPIO_OUTPUT_PUSH_PULL;
  gpio_init_struct.gpio_mode = GPIO_MODE_MUX;
  gpio_init_struct.gpio_pins = UDBTX_PIN;
  gpio_init_struct.gpio_pull = GPIO_PULL_NONE;
  gpio_init(UDBTX_GPIO_PORT, &gpio_init_struct);

  /* configure the RX pin */
  gpio_pin_mux_config(UDBRX_GPIO_PORT, GPIO_PINS_SOURCE11, GPIO_MUX_7);
  gpio_init_struct.gpio_drive_strength = GPIO_DRIVE_STRENGTH_MODERATE;
  gpio_init_struct.gpio_out_type = GPIO_OUTPUT_PUSH_PULL;
  gpio_init_struct.gpio_mode = GPIO_MODE_MUX;
  gpio_init_struct.gpio_pins = UDBRX_PIN;
  gpio_init_struct.gpio_pull = GPIO_PULL_NONE;
  gpio_init(UDBRX_GPIO_PORT, &gpio_init_struct);
